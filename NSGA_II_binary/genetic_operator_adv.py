...
def genetic_operator_adv(parent_pool,mutation_prob,input_v,bin_info_variable_list):
    import numpy as np 
    import copy 
    ...
    for i in range (0, dim_parent_pool[0]):
        ...
        if uniform(0,1) < 0.9:
            ...
            child_1_obj = evaluate_objective(dec_child_1, input_v)
            ...
            child_2_obj = evaluate_objective(dec_child_2, input_v)
            ...
            dim_parent_pool = parent_pool.shape 
            bit_len = dim_parent_pool[1] - input_v['M'] - 2                  ##The last 2 columns are for the objective function and the fitness respectively 
            ...
            child_3_obj = evaluate_objective(dec_child_3, input_v)
